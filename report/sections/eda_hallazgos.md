...
H8: Las condiciones pre-impacto separan el riesgo (fig11): zona rural 15.1% vs urbana 3.6%, y clima lluvioso 17.6% vs despejado 9.8%. Estas variables no existían en el dataset SUTRAN y son el aporte central del cambio de fuente.
