...
La búsqueda cerrada comparó tres configuraciones por tres semillas. El paquete final usa BCE, pesos de clase, Adam, L2, \emph{dropout}, \emph{early stopping} y \emph{ReduceLROnPlateau} durante selección. La calibración Platt corrige escala; no cambia ranking. No se aplicaron L1, SMOTE \cite{chawla_smote_2002}, \emph{stacking} ni \emph{batch normalization}, porque añadirlos sin evidencia y sin una cohorte nueva aumentaría multiplicidad.
