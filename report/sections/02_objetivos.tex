...
\begin{itemize}
  \item Selección de configuración completa: \textbf{mayor mediana de PR-AUC en validación 2023 entre semillas}; desempates por mayor F1 mediana y, después, menor IQR de PR-AUC. Cada configuración combina capas, dropout, L2 y tasa de aprendizaje.
