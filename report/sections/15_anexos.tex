...
|-- scripts/        Construccion del informe y verificacion final
...
\item Escenarios de demostración: \path{data/processed/demo_cases.csv}.
\item Auditoría de capacidad:\\
      \path{report/tables/design_capacity_architecture_summary.csv};\\
      \path{report/tables/design_capacity_sample_curve.csv}.
\end{itemize}
