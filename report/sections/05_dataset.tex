...
El ONSV publica en el mismo portal dos bases enlazables por \texttt{CÓDIGO SINIESTRO}:
\begin{itemize}
    \item vehículos: \path{data/raw/BBDD_ONSV_VEHICULOS_2021-2025.xlsx}, con 12\,667 filas, una por vehículo;
    \item personas: \path{data/raw/BBDD_ONSV_PERSONAS_2021-2025.xlsx}, con 25\,412 filas, una por persona y hasta 74 en un siniestro.
\end{itemize}
La cobertura del join es del 100\,\% sobre los 9\,104 códigos de la base limpia.

De estas tablas se derivan doce agregados por siniestro: total de vehículos; conteos de buses\slash minibuses, pesados de carga, motos\slash trimotos y vehículos no identificados; servicios interprovinciales y de transporte público; total de personas involucradas; pasajeros, peatones y conductores fugados; y edad media. Pertenecen al registro consolidado, pero su disponibilidad al instante de notificación no puede demostrarse sin timestamps por campo. Quedan \textbf{vetadas por fuga} las columnas de desenlace por persona y los dosajes etílicos. El conteo de personas involucradas es una variable de exposición estructural; se declara como limitación que el registro de ilesos podría ser más completo en siniestros graves.
