...
| 2026-07-08 | G | GUI Streamlit cableada al modelo real | `app/streamlit_app.py` usa `preparar_entrada()` compartido, `severidad_nn.keras`, `threshold.json` y demo cases | Checklist G automático pasó; respuesta 0.143s; código no visto, PUNO y comparación histórica no rompen |
...
| 2026-07-09 | F/G/H | Calibración post-hoc y CIs bootstrap | Se ajustó calibrador isotónico con validación, se agregó `models/calibrator.pkl`, `tab11`, `tab12` y `fig22` | Brier test baja de 0.2017 a 0.0970; GUI muestra score calibrado, no probabilidad operacional |
